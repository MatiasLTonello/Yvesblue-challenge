    ...
    <main>
        ...
        <table>
          <thead>
            ...
            <tr>
              <th
                className={
                  sort === "Company Name" ? "font-bold" : "font-normal"
                }
              ...
              <th
                className={
                  sort === "Total Revenue" ? "font-bold" : "font-normal"
                }
      ...
      <section>
        <div className="flex gap-1 items-center justify-center">
          {new Array(Math.ceil(SANITIZED_DATA.length / PAGE_SIZE))
            .fill(true)
            .map((_, index) => (
              <button
                className={page === index ? "font-bold" : "font-normal"}
                key={index}
